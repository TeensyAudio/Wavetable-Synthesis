...
const sample_data epiano_samples[4] = {
	{
		...
		RATE_NORMALIZED_ENV_COUNT(800.14), // DECAY_COUNT
		RATE_NORMALIZED_ENV_COUNT(680.26), // RELEASE_COUNT
		NEG_INV_COUNT(680.26), // RELEASE_COUNT
		SUSTAIN_DROP(49.6, 800.14), // SUSTAIN_MULT
	...
	},
	{
		...
		RATE_NORMALIZED_ENV_COUNT(1.00), // ATTACK_COUNT
		RATE_NORMALIZED_ENV_COUNT(20.01), // HOLD_COUNT
		RATE_NORMALIZED_ENV_COUNT(860.05), // DECAY_COUNT
		RATE_NORMALIZED_ENV_COUNT(680.26), // RELEASE_COUNT
		NEG_INV_COUNT(680.26), // RELEASE_COUNT
		SUSTAIN_DROP(47.5, 860.05), // SUSTAIN_MULT
		LFO_NORMALIZED_DELAY_COUNT(0.00), // VIBRATO_DELAY
		uint32_t(0.1 * LFO_PERIOD * (UINT32_MAX / AUDIO_SAMPLE_RATE_EXACT)), // VIBRATO_INCREMENT
		(CENTS_SHIFT(0) - 1.0) * 4, // VIBRATO_PITCH_COEFFICIENT_INITIAL
		(1.0 - CENTS_SHIFT(0)) * 4, // VIBRATO_COEFFICIENT_SECONDARY
	...
	},
	{
		...
		RATE_NORMALIZED_ENV_COUNT(680.26), // RELEASE_COUNT
		NEG_INV_COUNT(680.26), // RELEASE_COUNT
		SUSTAIN_DROP(49.6, 2000.00), // SUSTAIN_MULT
		LFO_NORMALIZED_DELAY_COUNT(0.00), // VIBRATO_DELAY
		uint32_t(0.1 * LFO_PERIOD * (UINT32_MAX / AUDIO_SAMPLE_RATE_EXACT)), // VIBRATO_INCREMENT
		(CENTS_SHIFT(0) - 1.0) * 4, // VIBRATO_PITCH_COEFFICIENT_INITIAL
		(1.0 - CENTS_SHIFT(0)) * 4, // VIBRATO_COEFFICIENT_SECONDARY
