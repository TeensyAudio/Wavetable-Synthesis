...
const sample_data oboe_samples[3] = {
	{
		...
		LFO_NORMALIZED_DELAY_COUNT(260.015), // MODULATION_DELAY
		LFO_INCREMENT(5.042), // MODULATION_INCREMENT
		LFO_FREQ_MULT(5.042, 9), // MODULATION_FREQ_MULT
		LFO_AMP_MULT(5.042, 0), // MODULTATION_AMP_MULT
	},
	{
