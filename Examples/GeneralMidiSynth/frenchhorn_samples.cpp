...
const sample_data frenchhorn_samples[1] = {
	{
		...
		RATE_NORMALIZED_ENV_COUNT(7.00), // ATTACK_COUNT
		RATE_NORMALIZED_ENV_COUNT(20.01), // HOLD_COUNT
		RATE_NORMALIZED_ENV_COUNT(11993.38), // DECAY_COUNT
		RATE_NORMALIZED_ENV_COUNT(986.23), // RELEASE_COUNT
		NEG_INV_COUNT(986.23), // RELEASE_COUNT
		SUSTAIN_DROP(14.9, 11993.38), // SUSTAIN_MULT
