...
const sample_data timpani_samples[7] = {
	{
		...
		RATE_NORMALIZED_ENV_COUNT(540.24), // HOLD_COUNT
		RATE_NORMALIZED_ENV_COUNT(3398.74), // DECAY_COUNT
		RATE_NORMALIZED_ENV_COUNT(2353.81), // RELEASE_COUNT
		NEG_INV_COUNT(2353.81), // RELEASE_COUNT
		SUSTAIN_DROP(100.0, 3398.74), // SUSTAIN_MULT
	...
	},
	{
		...
		RATE_NORMALIZED_ENV_COUNT(540.24), // HOLD_COUNT
		RATE_NORMALIZED_ENV_COUNT(3398.74), // DECAY_COUNT
		RATE_NORMALIZED_ENV_COUNT(1393.94), // RELEASE_COUNT
		NEG_INV_COUNT(1393.94), // RELEASE_COUNT
		SUSTAIN_DROP(100.0, 3398.74), // SUSTAIN_MULT
		LFO_NORMALIZED_DELAY_COUNT(0.00), // VIBRATO_DELAY
		uint32_t(0.1 * LFO_PERIOD * (UINT32_MAX / AUDIO_SAMPLE_RATE_EXACT)), // VIBRATO_INCREMENT
		(CENTS_SHIFT(0) - 1.0) * 4, // VIBRATO_PITCH_COEFFICIENT_INITIAL
	...
	{
		(int16_t*)sample_3_timpani_timpani, // sample
		true, // LOOP
		13, // LENGTH_BITS
		(1 << (32 - 13)) * CENTS_SHIFT(0) * 44100.0 / NOTE(60) / AUDIO_SAMPLE_RATE_EXACT + 0.5, // PER_HERTZ_PHASE_INCREMENT
		((uint32_t)7698 - 1) << (32 - 13), // MAX_PHASE
		...
		RATE_NORMALIZED_ENV_COUNT(6.20), // ATTACK_COUNT
		RATE_NORMALIZED_ENV_COUNT(540.24), // HOLD_COUNT
		RATE_NORMALIZED_ENV_COUNT(3198.73), // DECAY_COUNT
		RATE_NORMALIZED_ENV_COUNT(918.06), // RELEASE_COUNT
		NEG_INV_COUNT(918.06), // RELEASE_COUNT
		SUSTAIN_DROP(100.0, 3198.73), // SUSTAIN_MULT
		LFO_NORMALIZED_DELAY_COUNT(0.00), // VIBRATO_DELAY
		uint32_t(0.1 * LFO_PERIOD * (UINT32_MAX / AUDIO_SAMPLE_RATE_EXACT)), // VIBRATO_INCREMENT
		(CENTS_SHIFT(0) - 1.0) * 4, // VIBRATO_PITCH_COEFFICIENT_INITIAL
		(1.0 - CENTS_SHIFT(0)) * 4, // VIBRATO_COEFFICIENT_SECONDARY
	...
	{
		(int16_t*)sample_4_timpani_timpani, // sample
		true, // LOOP
		13, // LENGTH_BITS
		(1 << (32 - 13)) * CENTS_SHIFT(0) * 44100.0 / NOTE(60) / AUDIO_SAMPLE_RATE_EXACT + 0.5, // PER_HERTZ_PHASE_INCREMENT
		((uint32_t)7698 - 1) << (32 - 13), // MAX_PHASE
		...
		RATE_NORMALIZED_ENV_COUNT(6.20), // ATTACK_COUNT
		RATE_NORMALIZED_ENV_COUNT(540.24), // HOLD_COUNT
		RATE_NORMALIZED_ENV_COUNT(2998.35), // DECAY_COUNT
		RATE_NORMALIZED_ENV_COUNT(918.06), // RELEASE_COUNT
		NEG_INV_COUNT(918.06), // RELEASE_COUNT
		SUSTAIN_DROP(100.0, 2998.35), // SUSTAIN_MULT
		LFO_NORMALIZED_DELAY_COUNT(0.00), // VIBRATO_DELAY
		uint32_t(0.1 * LFO_PERIOD * (UINT32_MAX / AUDIO_SAMPLE_RATE_EXACT)), // VIBRATO_INCREMENT
		(CENTS_SHIFT(0) - 1.0) * 4, // VIBRATO_PITCH_COEFFICIENT_INITIAL
		(1.0 - CENTS_SHIFT(0)) * 4, // VIBRATO_COEFFICIENT_SECONDARY
	...
	{
		(int16_t*)sample_5_timpani_timpani, // sample
		true, // LOOP
		13, // LENGTH_BITS
		(1 << (32 - 13)) * CENTS_SHIFT(0) * 44100.0 / NOTE(60) / AUDIO_SAMPLE_RATE_EXACT + 0.5, // PER_HERTZ_PHASE_INCREMENT
		((uint32_t)7698 - 1) << (32 - 13), // MAX_PHASE
		...
		RATE_NORMALIZED_ENV_COUNT(6.20), // ATTACK_COUNT
		RATE_NORMALIZED_ENV_COUNT(540.24), // HOLD_COUNT
		RATE_NORMALIZED_ENV_COUNT(2799.17), // DECAY_COUNT
		RATE_NORMALIZED_ENV_COUNT(918.06), // RELEASE_COUNT
		NEG_INV_COUNT(918.06), // RELEASE_COUNT
		SUSTAIN_DROP(100.0, 2799.17), // SUSTAIN_MULT
		LFO_NORMALIZED_DELAY_COUNT(0.00), // VIBRATO_DELAY
		uint32_t(0.1 * LFO_PERIOD * (UINT32_MAX / AUDIO_SAMPLE_RATE_EXACT)), // VIBRATO_INCREMENT
		(CENTS_SHIFT(0) - 1.0) * 4, // VIBRATO_PITCH_COEFFICIENT_INITIAL
		(1.0 - CENTS_SHIFT(0)) * 4, // VIBRATO_COEFFICIENT_SECONDARY
	...
	{
		(int16_t*)sample_6_timpani_timpani, // sample
		true, // LOOP
		13, // LENGTH_BITS
		(1 << (32 - 13)) * CENTS_SHIFT(0) * 44100.0 / NOTE(60) / AUDIO_SAMPLE_RATE_EXACT + 0.5, // PER_HERTZ_PHASE_INCREMENT
		((uint32_t)7698 - 1) << (32 - 13), // MAX_PHASE
		...
		RATE_NORMALIZED_ENV_COUNT(6.20), // ATTACK_COUNT
		RATE_NORMALIZED_ENV_COUNT(540.24), // HOLD_COUNT
		RATE_NORMALIZED_ENV_COUNT(2599.68), // DECAY_COUNT
		RATE_NORMALIZED_ENV_COUNT(918.06), // RELEASE_COUNT
		NEG_INV_COUNT(918.06), // RELEASE_COUNT
		SUSTAIN_DROP(100.0, 2599.68), // SUSTAIN_MULT
		LFO_NORMALIZED_DELAY_COUNT(0.00), // VIBRATO_DELAY
		uint32_t(0.1 * LFO_PERIOD * (UINT32_MAX / AUDIO_SAMPLE_RATE_EXACT)), // VIBRATO_INCREMENT
		(CENTS_SHIFT(0) - 1.0) * 4, // VIBRATO_PITCH_COEFFICIENT_INITIAL
		(1.0 - CENTS_SHIFT(0)) * 4, // VIBRATO_COEFFICIENT_SECONDARY
...
const uint32_t sample_3_timpani_timpani[3968] = {
0x00000000,0xfff9fff5,0xfff9fff5,0x0004fff5,0x004fffd7,0x010dff91,0x0f21fd95,0x4fbb460b,
0x598a625b,0x40225439,0x1dc43113,0xcebe1dfc,0xa00faa38,0x8dee95d9,0xa37e9a5c,0xc251ae3d,
0xce93bae0,0x0511d76d,0x3eb12a28,0x4c583de2,0x57c249d3,0x71fb4441,0x23dd71fb,0xe630f1b5,
0xe648e7ed,0xeec9ef46,0xcda5dd06,0xb7a1c669,0x8ede8dee,0x8dee8dee,0x8dee8dee,0xc0548ff3,
...
const uint32_t sample_4_timpani_timpani[3968] = {
0x00000000,0xfff9fff5,0xfff9fff5,0x0004fff5,0x004fffd7,0x010dff91,0x0f21fd95,0x4fbb460b,
0x598a625b,0x40225439,0x1dc43113,0xcebe1dfc,0xa00faa38,0x8dee95d9,0xa37e9a5c,0xc251ae3d,
0xce93bae0,0x0511d76d,0x3eb12a28,0x4c583de2,0x57c249d3,0x71fb4441,0x23dd71fb,0xe630f1b5,
0xe648e7ed,0xeec9ef46,0xcda5dd06,0xb7a1c669,0x8ede8dee,0x8dee8dee,0x8dee8dee,0xc0548ff3,
...
const uint32_t sample_5_timpani_timpani[3968] = {
0x00000000,0xfff9fff5,0xfff9fff5,0x0004fff5,0x004fffd7,0x010dff91,0x0f21fd95,0x4fbb460b,
0x598a625b,0x40225439,0x1dc43113,0xcebe1dfc,0xa00faa38,0x8dee95d9,0xa37e9a5c,0xc251ae3d,
0xce93bae0,0x0511d76d,0x3eb12a28,0x4c583de2,0x57c249d3,0x71fb4441,0x23dd71fb,0xe630f1b5,
0xe648e7ed,0xeec9ef46,0xcda5dd06,0xb7a1c669,0x8ede8dee,0x8dee8dee,0x8dee8dee,0xc0548ff3,
...
const uint32_t sample_6_timpani_timpani[3968] = {
0x00000000,0xfff9fff5,0xfff9fff5,0x0004fff5,0x004fffd7,0x010dff91,0x0f21fd95,0x4fbb460b,
0x598a625b,0x40225439,0x1dc43113,0xcebe1dfc,0xa00faa38,0x8dee95d9,0xa37e9a5c,0xc251ae3d,
0xce93bae0,0x0511d76d,0x3eb12a28,0x4c583de2,0x57c249d3,0x71fb4441,0x23dd71fb,0xe630f1b5,
0xe648e7ed,0xeec9ef46,0xcda5dd06,0xb7a1c669,0x8ede8dee,0x8dee8dee,0x8dee8dee,0xc0548ff3,
