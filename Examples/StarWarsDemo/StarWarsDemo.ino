...
const instrument_data* const midi_map[] = {
	&trumpet, &trumpet, &trumpet, &trumpet, &trumpet, &trumpet, &trumpet, &trumpet, // 000: trumpets
	&glockenspiel, &glockenspiel, &glockenspiel, &glockenspiel, &glockenspiel, &glockenspiel, &glockenspiel, &glockenspiel, // 008: chrom percus
	&trumpet, &trumpet, &trumpet, &trumpet, &trumpet, &trumpet, &trumpet, &trumpet, // 016: organs
	&trumpet, &trumpet, &trumpet, &trumpet, &trumpet, &trumpet, &trumpet, &trumpet, // 024: guitars
	&trumpet, &trumpet, &trumpet, &trumpet, &trumpet, &trumpet, &trumpet, &trumpet, // 032: bass
	...
	&trumpet, &trombone, &tuba, &trumpet, &frenchhorn, &trumpet, &trumpet, &trumpet, // 056: brass
	&oboe, &oboe, &oboe, &oboe, &oboe, &oboe, &bassoon, &clarinet, // 064: reed
	&flute, &flute, &flute, &flute, &flute, &flute, &flute, &flute, // 072: pipe
	// 080: synth lead
	...
	&trumpet, &trumpet, &trumpet, &trumpet, &trumpet, &trumpet, &trumpet, &trumpet,
	// 112: percussive
	&timpani, &timpani, &timpani, &timpani, &timpani, &timpani, &timpani, &timpani,
	// 120: sound effects
	&timpani, &timpani, &timpani, &timpani, &timpani, &timpani, &timpani, &timpani,
};

const instrument_data* channel_map[17] = {
	&trumpet, &trumpet, &trumpet, &trumpet, &trumpet, &trumpet, &trumpet, &trumpet, &trumpet, &trumpet, &standard_DRUMS, &trumpet, &trumpet, &trumpet, &trumpet, &trumpet, &trumpet,
};
